...
def response(sent_tokens,user_response):
    ...
    if(req_tfidf==0):
        ...
        print("THIS IS THE SENTENCE MOST SIMILAR TO THE USER INPUT")
...
def chatbot():
  ...
  #TODO 4: print the words "THIS ARE THE SENTENCE TOKENS"
  print("THESE ARE THE SENTANCE TOKENS")
